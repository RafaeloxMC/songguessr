        ...
        <div className="flex flex-col items-center justify-center h-full">
            ...
            {!gameMode && !playlist ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 items-center justify-center">
                    ...
                    /> */}
                    {playlists.length === 0 ? <div></div> : null}
                    {playlists.length === 0 ? (
                        <div className="flex flex-col items-center justify-center h-full">
                            <p className="text-center mb-4">
                                No playlists available. Please create a playlist
                                first.
                            </p>
                            <Button
                        ...
                        playlists.map((playlistItem) => (
                            <PlaylistCard
                                ...
                                onClick={() => setPlaylist(playlistItem.name)}
                            />
                        ))
                    )}
                </div>
                ...
                <div className="flex flex-col items-center gap-4">
                    ...
                    <Button
                        ...
                        onClick={() => {
                            alert(
                                `Starting ${gameMode} game on ${playlist} playlist!`
                            );
